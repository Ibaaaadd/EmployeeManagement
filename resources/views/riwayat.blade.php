                ...
                <form method="GET" action="{{ route('gaji.riwayat') }}" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="month" name="bulan" class="form-control border-start-0 ps-0 datepicker-month" value="{{ request('bulan') }}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <label class="form-label d-none d-md-block">&nbsp;</label>
                        <button type="submit" class="btn btn-primary w-100 rounded-pill shadow-sm d-flex align-items-center justify-content-center">
        ...
        <div class="card border-0 shadow-sm animate__animated animate__fadeInUp" style="border-radius: 20px;">
            <div class="card-body p-4">
                ...
                <div class="alert alert-warning text-center rounded-3 border-0">
                    <i class="fa-solid fa-circle-exclamation me-2"></i> Data riwayat penggajian yang Anda input tidak tersedia.
                </div>
                @else
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('riwayat.preview', $item->id) }}" class="btn btn-sm btn-outline-secondary rounded-pill px-3" target="_blank">
                                                <i class="fa-solid fa-eye me-1"></i> View
                                            </a>
                                            <a href="{{ route('riwayat.download', $item->id) }}" class="btn btn-sm btn-danger rounded-pill px-3 shadow-sm">
